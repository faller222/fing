...
public class Orden extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            IVerInfoCliente IVC = new IVerInfoCliente();
            IVC.seleccionarCliente(user.getNickname());
            List Ordenes = IVC.listarOrdenesCliente();

            request.setAttribute("Ordenes", Ordenes);

            request.getRequestDispatcher("/WEB-INF/pages/verOrdenes.jsp").forward(request, response);
            return;
        } catch (Exception e) {
