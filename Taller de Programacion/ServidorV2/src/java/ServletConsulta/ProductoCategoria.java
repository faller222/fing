...
public class ProductoCategoria extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String Ct = (String) request.getParameter("Cate");
            IVerProducto IVMP = new IVerProducto();
            IVMP.seleccionarCategoria(Ct);
            List<Object> productos = IVMP.listarProductosCategoria();
