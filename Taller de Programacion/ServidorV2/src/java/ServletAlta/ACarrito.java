...
@WebServlet(name = "AgregarProductoCarrito", urlPatterns = {"/AgregarProductoCarrito"})
public class ACarrito extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            nR = Integer.parseInt(request.getParameter("idProducto"));
            HttpSession Sesion = request.getSession();
            ISesion Ses = (ISesion) Sesion.getAttribute("Sesion");
            Ses.agregaLinea(cantidad, nR);
            request.getRequestDispatcher("Carrito").forward(request, response);
            return;
        } catch (Exception e) {
            request.getRequestDispatcher("VerProducto?nRef=" + nR).forward(request, response);
        }
    }
