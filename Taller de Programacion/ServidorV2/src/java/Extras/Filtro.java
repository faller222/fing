...
public class Filtro implements Filter {
    ...
    private void actualizar(HttpServletRequest request) {
        ...
        if (TL == null) {
            if (IS == null) {
                Sesion.setAttribute("TipoLog", TipoLogIn.VISITANTE);
            } else {
                if (IS.verInfoPerfil() == null) {
                    Sesion.setAttribute("TipoLog", TipoLogIn.VISITANTE);
                }
            }
        }
...
// <editor-fold defaultstate="collapsed" desc="Codigo Ejemplo .">
	...
	/*
        ...
        actualizar((HttpServletRequest) request);
        try {
            (new gestorAcceso()).log(request);
        } catch (Exception e) {
        }
    }
