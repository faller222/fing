...
bool TextureManager::LoadTexture(const char* filename, const unsigned int texID, bool useMipmaps, GLenum image_format, GLint internal_format, GLint level, GLint border)
{
	//image format
